...
Public Class rpt_Requisicion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.rpt_Requisicion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cod_requisicion() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_Requisicion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Requisicion = New rpt_Requisicion()
        rpt.Site = Me.Site
        Return rpt
    End Function
