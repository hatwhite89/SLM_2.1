...
Public Class rpt_ordenMensual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.rpt_ordenMensual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ordenMensual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ordenMensual = New rpt_ordenMensual()
        rpt.Site = Me.Site
        Return rpt
    End Function
