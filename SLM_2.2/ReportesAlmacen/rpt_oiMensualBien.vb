...
Public Class rpt_oiMensualBien
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.rpt_oiMensualBien.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_oiMensualBien
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_oiMensualBien = New rpt_oiMensualBien()
        rpt.Site = Me.Site
        Return rpt
    End Function
