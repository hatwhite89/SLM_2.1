Public Class ReporteReactivos
    Private Sub ReporteInventarioInsumos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ComboAlmacen()
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim RptDocument As New rpt_reporteReactivo
