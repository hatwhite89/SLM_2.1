...
Public Class rpt_reporteInsumos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.rpt_reporteInsumos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_reporteInsumos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_reporteInsumos = New rpt_reporteInsumos()
        rpt.Site = Me.Site
        Return rpt
    End Function
