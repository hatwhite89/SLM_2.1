...
Public Class rpt_solicitudInterna
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_solicitudInterna.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.rpt_solicitudInterna.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_oi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_solicitudInterna
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_solicitudInterna = New rpt_solicitudInterna()
        rpt.Site = Me.Site
        Return rpt
    End Function
