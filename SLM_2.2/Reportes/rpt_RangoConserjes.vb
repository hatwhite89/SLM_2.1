...
Public Class rpt_RangoConserjes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.rpt_RangoConserjes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_RangoConserjes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_RangoConserjes = New rpt_RangoConserjes()
        rpt.Site = Me.Site
        Return rpt
    End Function
