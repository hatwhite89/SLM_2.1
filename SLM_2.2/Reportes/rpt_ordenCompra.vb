...
Public Class rpt_ordenCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.rpt_ordenCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_oc() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_ordenCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ordenCompra = New rpt_ordenCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
