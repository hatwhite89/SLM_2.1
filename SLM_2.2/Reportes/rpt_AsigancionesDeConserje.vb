...
Public Class rpt_AsigancionesDeConserje
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_AsigancionesDeConserje.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.rpt_AsigancionesDeConserje.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_codEmpleado() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_AsigancionesDeConserje
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_AsigancionesDeConserje = New rpt_AsigancionesDeConserje()
        rpt.Site = Me.Site
        Return rpt
    End Function
