...
Public Class rpt_centrodecostos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.rpt_centrodecostos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_centrodecostos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_centrodecostos = New rpt_centrodecostos()
        rpt.Site = Me.Site
        Return rpt
    End Function
