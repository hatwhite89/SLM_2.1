Public Class M_ListadoDepartamentos
    ...
    Private Sub dgbtabla_CellMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgbtabla.CellMouseDoubleClick
        Try
            If lblform.Text = "M_Empleados" Then
                ...
                End If
                If n = vbYes Then
                    M_Empleados.lblcodeDepto.Text = dgbtabla.Rows(e.RowIndex).Cells(0).Value()
                    M_Empleados.txtdepartamento.Text = dgbtabla.Rows(e.RowIndex).Cells(1).Value()
