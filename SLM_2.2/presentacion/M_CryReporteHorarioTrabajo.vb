...
Public Class M_CryReporteHorarioTrabajo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "M_CryReporteHorarioTrabajo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.M_CryReporteHorarioTrabajo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_codigoHorario() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedM_CryReporteHorarioTrabajo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As M_CryReporteHorarioTrabajo = New M_CryReporteHorarioTrabajo()
        rpt.Site = Me.Site
        Return rpt
    End Function
