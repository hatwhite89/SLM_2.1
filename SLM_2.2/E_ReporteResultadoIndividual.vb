...
Public Class E_ReporteResultadoIndividual
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "E_ReporteResultadoIndividual.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.E_ReporteResultadoIndividual.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_orden() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedE_ReporteResultadoIndividual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As E_ReporteResultadoIndividual = New E_ReporteResultadoIndividual()
        rpt.Site = Me.Site
        Return rpt
    End Function
