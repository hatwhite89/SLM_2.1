...
Public Class ClsDetalleValorRefTxt
    ...
    Public Function buscarDetalleValorRefTxtParametro(ByVal nombreParametro As String) As DataTable
        ...
        Using cmd As New SqlCommand
            ...
            cmd.CommandText = "A_slmBuscarDetalleValorReferenciaTxtNombreP"
