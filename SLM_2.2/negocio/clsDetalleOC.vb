...
Public Class clsDetalleOC
    ...
    Public Function ListarDetalleOCEntrada(ByVal cod As String) As DataTable
        ...
        Using da As New SqlDataAdapter("select id_detalle_oc, cod_producto,nombre_producto,num_lote,precio_unitario,cantidad,costo_total from DetalleOrdenCompra where id_oc ='" + cod + "' and estado_ingresado = 0", cn)
            Dim dt As New DataTable
            da.Fill(dt)
            Return dt
        End Using
