...
Public Class ClsDescuentos
    Dim codigo, porcentaje As Integer
    ...
    Public Property codigoBreve_ As String
        ...
        End Set
    End Property
    Public Function RegistrarNuevoDescuento() As String
        ...
        sqlcom.CommandText = "M_slmInsertarDescuento"
    ...
    Public Function ModificarDescuento() As String
        Dim sqlcom As SqlCommand
        Dim sqlpar As SqlParameter
        Dim par_sal As Integer
        ...
        sqlcom = New SqlCommand
        sqlcom.CommandType = CommandType.StoredProcedure
        sqlcom.CommandText = "M_slmModificarDescuento"
    ...
    Public Function BuscarDescuentoCode() As DataTable
        ...
        Using cmd As New SqlCommand
            ...
            cmd.CommandText = "M_slmBuscarDescuentoCode"
    ...
    Public Function SeleccionarDescuento() As DataTable

        Dim objCon As New ClsConnection
        Dim cn As New SqlConnection
        cn = objCon.getConexion

        Using da As New SqlDataAdapter("M_slmSeleccionarDescuento", cn)
