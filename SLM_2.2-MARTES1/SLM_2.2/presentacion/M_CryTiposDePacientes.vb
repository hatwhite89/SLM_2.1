...
Public Class M_CryTiposDePacientes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "M_CryTiposDePacientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.M_CryTiposDePacientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedM_CryTiposDePacientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As M_CryTiposDePacientes = New M_CryTiposDePacientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
