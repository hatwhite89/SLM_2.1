...
Public Class InformeOrdenesDeTrabajoExamen
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InformeOrdenesDeTrabajoExamen.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SLM_2._2.InformeOrdenesDeTrabajoExamen.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_codExamen() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedInformeOrdenesDeTrabajoExamen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformeOrdenesDeTrabajoExamen = New InformeOrdenesDeTrabajoExamen()
        rpt.Site = Me.Site
        Return rpt
    End Function
